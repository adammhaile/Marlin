...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_LASER_MENU                      = _UxGT("Pen Control");
  PROGMEM Language_Str MSG_LASER_OFF                       = _UxGT("Pen Up");
  PROGMEM Language_Str MSG_LASER_ON                        = _UxGT("Pen Down");
  ...
  PROGMEM Language_Str MSG_RESET_PRINTER                   = _UxGT("Reset Plotter");
  ...
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("Start Plot");
  ...
  PROGMEM Language_Str MSG_BUTTON_PRINT                    = _UxGT("Plot");
  ...
  PROGMEM Language_Str MSG_PAUSE_PRINT                     = _UxGT("Pause Plot");
  PROGMEM Language_Str MSG_RESUME_PRINT                    = _UxGT("Resume Plot");
  PROGMEM Language_Str MSG_STOP_PRINT                      = _UxGT("Stop Plot");
  PROGMEM Language_Str MSG_PRINTING_OBJECT                 = _UxGT("Plotting Object");
  ...
  PROGMEM Language_Str MSG_MEDIA_MENU                      = _UxGT("Plot from Media");
  ...
  PROGMEM Language_Str MSG_PRINT_PAUSED                    = _UxGT("Plot Paused");
  PROGMEM Language_Str MSG_PRINTING                        = _UxGT("Plotting...");
  PROGMEM Language_Str MSG_PRINT_ABORTED                   = _UxGT("Plot Aborted");
  PROGMEM Language_Str MSG_PRINT_DONE                      = _UxGT("Plot Done");
  ...
  #if LCD_WIDTH >= 20
    PROGMEM Language_Str MSG_INFO_PRINT_COUNT              = _UxGT("Plot Count");
    PROGMEM Language_Str MSG_INFO_COMPLETED_PRINTS         = _UxGT("Completed");
    PROGMEM Language_Str MSG_INFO_PRINT_TIME               = _UxGT("Total Plot Time");
  ...
  #else
    PROGMEM Language_Str MSG_INFO_PRINT_COUNT              = _UxGT("Plots");
    PROGMEM Language_Str MSG_INFO_COMPLETED_PRINTS         = _UxGT("Completed");
